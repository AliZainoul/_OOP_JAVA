...
public class matrix extends abstractmatrix {
  ...
  // Size Constructor
  public matrix(int _size){super.size = _size;}

  // Copy Constructor
  public matrix(matrix _matrix){
    super.size = _matrix.getSize();
    super.matrix = _matrix.getMatrix();
  }

  // Size / same value Constructor
  public matrix(int _size, double _value){
    super.size = _size;
    super.matrix = fillwithvalue(_size, _value);
  }
  ...
  public void setMatrix(double[][] _matrix) {this.matrix = _matrix;}
  ...
  /*
  public vector matrix_vector_product(vector _v)
  {    
  }
  */
